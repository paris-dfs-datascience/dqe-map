...
1. DATA VALIDITY (0-60 points):
   - Employee Count Accuracy (0-40 points):
...
2. ICP FIT (0-40 points):
   - Infrastructure Criticality (0-20 points):
   ...
   - Revenue Potential (0-20 points):
     ...
     * 15 pts: 50-99 employees or medium-value vertical
     * 10 pts: 25-49 employees
     * 5 pts: 10-24 employees
     * 0 pts: 1-9 employees
...
"""
    ...
    def process_csv(self, csv_file: str) -> List[Dict]:
        """
        Process enriched CSV and generate battle cards.
        ...
        for idx, row in enumerate(rows, 1):
            print(f"[{idx}/{len(rows)}] Processing: {row.get('Name', 'Unknown')}")
...
def main():
    ...
    # Process CSV
    battle_cards = generator.process_csv(INPUT_CSV)
