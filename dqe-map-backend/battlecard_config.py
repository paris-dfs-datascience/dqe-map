...
CONNECTBASE DATA:
- CB Entity Name: {connectbase_data.get('API_EntityName') or 'Unknown'}
- CB Employee Count: {connectbase_data.get('API_NoOfEmployees') or 'Unknown'}
- CB Industry: {connectbase_data.get('API_Industry') or 'Unknown'}
- CB Location Type: {connectbase_data.get('API_LocationType') or 'Unknown'}
